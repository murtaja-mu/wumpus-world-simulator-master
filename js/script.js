var canvas,         // Canvas DOM element
    ...
    isFinished = false,
    player,
    rivalMonster; // The rival monster
...
function restart(){
    ...
    rivalMonster = new Monster(env, 14, 7);
...
function update(){
    ...
    var oldPlayerI = Math.round(player.x / env.width);
    var oldPlayerJ = Math.round(player.y / env.height);
    ...
    var newPlayerI = Math.round(player.x / env.width);
    var newPlayerJ = Math.round(player.y / env.height);
    

    var playerHasMoved = (oldPlayerI !== newPlayerI || oldPlayerJ !== newPlayerJ);
    ...
    if (playerHasMoved) {
        ...
        if (rivalMonster) {
            var killedByRival = rivalMonster.update(player); 
