    ...
    loadImages: function(){
        ...
        return new Promise((resolve, reject) => {
            ...
            const files = [
                ...
                // --- Rival Monster Images ---
                this.loadImage('rival-up', 'img/rival-up.png'),
                this.loadImage('rival-down', 'img/rival-down.png'),
                this.loadImage('rival-left', 'img/rival-left.png'),
                this.loadImage('rival-right', 'img/rival-right.png')
            ];
